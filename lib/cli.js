...
class SVGs {
  ...
  renderShape(){
    return `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="300" height="200">${this.shapeEl}${this.logoTextEl}</svg>`
  }
  textEl(chars, textColor, textX, textY) {
    this.logoTextEl = `<text x="150" y="125" font-size="45" text-align="center" fill="${textColor}">${chars}</text>`;
  }
